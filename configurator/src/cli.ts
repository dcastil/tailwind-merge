...
const main = async (argv: string[]) => {
    ...
    // The hash makes it possible to detect a stale generated file without re-running generation, and documents which input state the output belongs to.
    ...
    const banner = [
        ...
        `// Source: ${relative(dirname(outputPath), inputPath)} (sha256 ${contentHash})`,
    ].join('\n')
