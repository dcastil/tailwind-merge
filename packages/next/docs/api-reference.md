...
The stable import surface. While Next.js compiles your app, it serves the module generated from your theme; outside the Next.js compiler it falls back to tailwind-merge's default behavior with the same exports. The surface mirrors tailwind-merge's public API with your project's configuration swapped in:
