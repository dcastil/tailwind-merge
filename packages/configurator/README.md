...
**Status: unreleased, with an unstable API.** Use it from this repository for now. For Vite applications, prefer [@tailwind-merge/vite](../vite/README.md), and for Next.js applications [@tailwind-merge/next](../next/README.md); both handle generation and watching automatically and have dev builds on npm ahead of their first stable release. Direct configurator use is useful for other build pipelines and generated files.
