...
- Export ConfigExtension type from package by [@dcastil](https://github.com/dcastil) in [#505](https://github.com/dcastil/tailwind-merge/pull/505)

**Full Changelog**: [`v2.5.5...v2.6.0`](https://github.com/dcastil/tailwind-merge/compare/v2.5.5...v2.6.0)

Thanks to [@brandonmcconnell](https://github.com/brandonmcconnell), [@manavm1990](https://github.com/manavm1990), [@langy](https://github.com/langy), [@jamesreaco](https://github.com/jamesreaco), [@roboflow](https://github.com/roboflow), [@syntaxfm](https://github.com/syntaxfm), [@getsentry](https://github.com/getsentry), [@codecov](https://github.com/codecov), [@sourcegraph](https://github.com/sourcegraph), a private sponsor and more via [@thnxdev](https://github.com/thnxdev) for sponsoring tailwind-merge! ❤️
