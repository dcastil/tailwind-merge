...
- Unreleased workspace packages: `packages/configurator/` generates tailwind-merge configs from Tailwind v4 CSS; `packages/vite/` wraps it with automatic generation and usage pruning. Each has a maintained `README.md` and user documentation in `docs/`.
