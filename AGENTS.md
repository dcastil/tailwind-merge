...
- Tests: `tests/`
- Human docs: `docs/`
- Configurator exploration (research and prototype for generating tailwind-merge configs from Tailwind v4 CSS; not published, not part of the library build): `configurator/`
