...
-   Fully typed
-   [<!-- AUTOGENERATED START package-gzip-size -->4.6 kB<!-- AUTOGENERATED END --> minified + gzipped](https://bundlephobia.com/package/tailwind-merge) (<!-- AUTOGENERATED START package-composition -->100.0% self<!-- AUTOGENERATED END -->)
