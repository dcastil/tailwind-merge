...
| [@tailwind-merge/next](./packages/next/README.md)                                                 | The same for Next.js apps, with Turbopack and webpack. No stable release yet; dev builds on npm under the `dev` tag, manual for now. |
...
| [@tailwind-merge/plugin-core](./packages/plugin-core/README.md)                                   | Shared internals of the Vite and Next.js plugins (discovery, generation, refresh). Unpublished; inlined into both plugins.           |
