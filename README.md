...
| [@tailwind-merge/next](./packages/next/README.md)                                                 | The same for Next.js apps, with Turbopack and webpack. No stable release yet; dev builds on npm under the `dev` tag.                |
