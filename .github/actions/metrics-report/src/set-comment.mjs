...
const commentIdComment =
    "<!-- This is an autogenerated comment from metrics-report-action. Please don't copy this text to other comments. -->\n\n"
